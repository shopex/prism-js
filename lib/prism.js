...
var prism = function(server, key, secret){
    ...
    this.rpc = function(api, options){
        ...
        if(is_https){
            ...
            var urlparams = url.parse(api, true);
            GetParams = merge(GetParams, urlparams.query);
            params["sign_method"] = "md5";
            params["sign_time"] = Date.parse(new Date())/1000;
            params["sign"] = sign(options.type, reqopt.path+urlparams.pathname, {}, GetParams, PostParams, this.secret())
        }
